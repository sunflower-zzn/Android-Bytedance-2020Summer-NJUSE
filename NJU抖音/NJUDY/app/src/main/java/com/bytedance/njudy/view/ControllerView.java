...
import com.bytedance.njudy.utils.AutoLinkHerfManager;
...
public class ControllerView extends RelativeLayout implements View.OnClickListener {
    ...
    public void setVideoData(VideoBean videoData) {
        ...
        Glide.with(this).load(videoData.getUserBean().getAvatar()).into(ivHead);
        tvNickname.setText("@" + videoData.getUserBean().getNickName());
        AutoLinkHerfManager.setContent(videoData.getContent(), autoLinkTextView);
        Glide.with(this).load(videoData.getUserBean().getAvatar()).into(ivHeadAnim);
