...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        if(note.getPriority().intValue==1){
            relativeLayout.setBackgroundColor(Color.parseColor("#FC4273"));
            relativeLayout.getBackground().setAlpha(100);
        }
        else if(note.getPriority().intValue==2){
            relativeLayout.setBackgroundColor(Color.parseColor("#0499FD"));
            relativeLayout.getBackground().setAlpha(100);
        }
        else{relativeLayout.setBackgroundColor(Color.parseColor("#FFFFFF"));}
